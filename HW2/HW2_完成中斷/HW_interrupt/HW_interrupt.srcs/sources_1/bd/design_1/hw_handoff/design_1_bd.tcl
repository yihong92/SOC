...
proc create_root_design { parentCell } {
  ...
  set stop_btn [ create_bd_port -dir I stop_btn ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins interrupt_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins interrupt_0/S_AXI_INTR] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net btn_1 [get_bd_ports btn] [get_bd_pins interrupt_0/btn]
  connect_bd_net -net interrupt_0_irq [get_bd_pins interrupt_0/irq] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net interrupt_0_led [get_bd_ports led] [get_bd_pins interrupt_0/led]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins interrupt_0/s00_axi_aresetn] [get_bd_pins interrupt_0/s_axi_intr_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins interrupt_0/s00_axi_aclk] [get_bd_pins interrupt_0/s_axi_intr_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net stop_btn_1 [get_bd_ports stop_btn] [get_bd_pins interrupt_0/stop_btn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs interrupt_0/S00_AXI/S00_AXI_reg] SEG_interrupt_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs interrupt_0/S_AXI_INTR/S_AXI_INTR_reg] SEG_interrupt_0_S_AXI_INTR_reg
