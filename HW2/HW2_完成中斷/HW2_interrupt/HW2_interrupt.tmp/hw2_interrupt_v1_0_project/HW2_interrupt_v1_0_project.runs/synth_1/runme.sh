...
HD_PWD='c:/soc/hw2_interrupt/hw2_interrupt.tmp/hw2_interrupt_v1_0_project/HW2_interrupt_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HW2_interrupt_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HW2_interrupt_v1_0.tcl
