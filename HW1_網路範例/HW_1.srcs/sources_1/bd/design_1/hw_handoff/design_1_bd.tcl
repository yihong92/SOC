...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set LED_output [ create_bd_port -dir O -from 7 -to 0 -type data LED_output ]
  ...
  connect_bd_net -net LED_0_LED_output [get_bd_ports LED_output] [get_bd_pins LED_0/LED_output]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins LED_0/LED_input] [get_bd_pins axi_gpio_0/gpio_io_o]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins LED_0/clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins LED_0/reset]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins LED_0/sw]
